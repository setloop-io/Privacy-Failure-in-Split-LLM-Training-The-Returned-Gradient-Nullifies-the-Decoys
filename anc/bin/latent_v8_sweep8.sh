#!/usr/bin/env bash
# Latent-v8 sweep 8: maximum cloud depth probe on the 35B MoE (E=32 fixed).
# L=40 matches the model's full real depth; L=64 is an over-depth stress
# probe.  Operating point: noise 0.40, chaff 48.
set -uo pipefail
...
run_cell moe32_L40_35b_s42 40 5019
run_cell moe32_L64_35b_s42 64 5020
